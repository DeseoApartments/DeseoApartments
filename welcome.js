...
function calculatePrice() {
    ...
    if (historicalCenters[city]) {
        ...
        document.getElementById("price-result").innerHTML = `
            <div><span style="color: black;margin-top:20px;margin-bottom:35px;">Possibile Rendita*</span></div>
            <span style="color: red;font-size: 60px;margin-top:20px;">${totalPrice} €</span>`;
    } else {
