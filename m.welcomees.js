    ...
    if (historicalCenters[city]) {
        ...
        if (bounds.contains(latLng)) {
            ...
            document.getElementById("result").innerHTML = `
                <span style="color: black;font-size:15px;font-family: 'Helvetica Neue', Helvetica, Arial, sans-serif;">Tarifa media por noche en la zona:</span>
        ...
        if (nearestCity) {
            ...
            const discountedPricePerNight = Math.floor(nearestCityPriceRange * discountRate);
...
function calculatePrice() {
    ...
    if (historicalCenters[city]) {
        ...
        document.getElementById("price-result").innerHTML = `
            ...
            <div><a href="m.tariffees.html" style="color:blue;font-size:3vw;font-family: 'Helvetica Neue', Helvetica, Arial, sans-serif;">* Formula</a></div><br>`
            ;
    } else {
        ...
        if (nearestCity && historicalCenters[nearestCity]) {
            ...
            <span style="color: rgba(44, 44, 44, 0.701);font-size: 5vh;margin-top:3vh;font-family: 'Helvetica Neue', Helvetica, Arial, sans-serif;">${totalPrice} €</span>
            <div><a href="m.tariffees.html" style="color:blue;font-size:3vw;font-family: 'Helvetica Neue', Helvetica, Arial, sans-serif;">* Formula</a></div></center><br>`;
        } else {
