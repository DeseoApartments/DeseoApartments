...
function updateResult(latLng, addressComponents) {
    ...
    if (historicalCenters[city]) {
        ...
        if (nearestCity) {
            ...
            document.getElementById("result").innerHTML = `
                <span style="color: black;font-size:15px;">Tarifa media por noche en la zona:</span>
...
function calculatePrice() {
    ...
    if (historicalCenters[city]) {
        ...
        document.getElementById("price-result").innerHTML = `
            ...
            <div><a href="tariffees.html" style="color:blue;font-size:0.7vw;font-family: 'Helvetica Neue', Helvetica, Arial, sans-serif;">Formula</a></div></center><br>
            `
            ;
    } else {
